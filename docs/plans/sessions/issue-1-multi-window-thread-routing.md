...
change_contract:
  ...
  stale_verdict_invalidation_refs:
    ...
    - 2026-08-14 源码 checkpoint 门禁只属于 git:4f52a4fdf45481da908e2c467a80ec16c68d32f2；治理提交后必须对 final exact HEAD/tree 重新审查
  regression_checks:
  ...
  protected_feature_replay:
    ...
    known_good_features:
      - feature: thread reservation and current-thread recovery
        ...
        post_change_replay_ref: git:4f52a4fdf45481da908e2c467a80ec16c68d32f2-local-source-gate:2026-08-14T05:50:15+08:00
        expected_result: reservation suite and aggregate selftests pass
        actual_result: PowerShell 完整链无重试通过 sidebar bundle 218.6kb、13/13 Node 自测文件和 branding 22 文件检查；reservation 57/57、ConversationStore 32/32、失败高 claim 发布与生产删除 helper 当前/非当前动态合同通过
...
execution_evidence:
  test:
    ...
    result_ref: git:4f52a4fdf45481da908e2c467a80ec16c68d32f2-local-source-gate:2026-08-14T05:50:15+08:00-sidebar-and-13-selftests-pass
  build:
    command_ref: build.md#侧栏构建
    result_ref: git:4f52a4fdf45481da908e2c467a80ec16c68d32f2-local-source-gate:2026-08-14T05:50:15+08:00-bundle-218.6kb
  review:
    command_ref: build.md#独立审查
    result_ref: git:e84e4b18ac250614979876b68e810a6fc2845d16-request-changes-p1-1-p2-2; git:f92d93752aecbec3edf33bce5486fe8d95935371-provider-503-no-verdict; reviewers:019ffcda-2437-7791-a95a-54cab6ca68a8,019ffcee-5f0d-7892-977e-eced1beb2c71-shutdown-no-verdict; fresh final exact-head rereview pending
  verification:
    command_ref: build.md#交付边界检查
    result_ref: git:4f52a4fdf45481da908e2c467a80ec16c68d32f2-local-source-gate:2026-08-14T05:50:15+08:00-lockfile-ignored-bundle-and-12-file-boundary-pass
  closeout:
